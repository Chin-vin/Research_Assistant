...
# #         # Stream with live status + early exit on critical error
# #         events = graph.stream(
# #             initial_state,
...
# #                     agent_box.info(f"Running agent: {node}")
...
# #             final_result["critical_error"] = True
...
# #             status_box.error(
# #                 "Rate limit or API error occurred during workflow execution."
# #             )

# #             stream_box.code(str(stream_error))
...
# #             status_box.error(
# #                 "Workflow failed due to API/model error."
# #             )
...
# #     except Exception as e:
# #         raw_tb = traceback.format_exc()
# #         save_error_message([str(e), raw_tb])
# #         current_session["workflow_running"] = False
# #         st.session_state["reset_query"] = True
# #         st.session_state["uploader_reset_counter"] += 1
# #         st.rerun()
